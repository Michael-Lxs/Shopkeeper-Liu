...
def save_file(filename,meaning):
    meaning_file = open(filename, 'a')
    meaning_file.writelines(meaning+'\n')
    meaning = []
    meaning_file.close()
...
if __name__ == '__main__':
    ...
    f = open(r'D:\desktop\word.txt', encoding='UTF-8')
    filename = r'D:\desktop\meaning.txt'
    line = f.readlines()
    for each_line in line:
        text = Tencent.get_trans_result(each_line)
        print(text)
